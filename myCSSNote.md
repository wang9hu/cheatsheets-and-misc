...
4. <mark>Bootstrap</mark>:
   ...
   2. another way to use bootstrap is to download bootstrap source file (sass source files) and make customized sass and compile it in sass compiler
   3. bootstrap 5 doesn't require jquery as a dependency
      <br>
